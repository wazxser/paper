...
<div class="container">
    ...
    <div class="row">
        <div class="box">
            ...
            <div class="col-md-12">
                <label>上传者： </label><?php echo ($up); ?><br/>
                <label>关键词： </label><?php echo ($keyword); ?><br/>
                <label>描述： </label><p><?php echo ($content); ?></p><br/>
                <label>下载文件所需积分：  </label><?php echo ($value); ?><br/>
                <label>分享时间：  </label><?php echo ($ctime); ?><br/>
                <label>文档：  </label>
                <a id="a" href="<?php echo U('Home/Lunwen/download');?>?id=<?php echo ($id); ?>"><?php echo ($filename); ?></button></a>
            </div>
    ...
    <div class="row">
        <div class="box">
            ...
            <form action='chakan?id=<?php echo ($id); ?>' method="post">
    ...
    <?php if(is_array($com)): $i = 0; $__LIST__ = $com;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?><div class="row">
            <div class="box">
                <?php echo ($com["user"]); ?>:  <?php echo ($com["content"]); ?>
                <div class="clearfix"></div>
            </div>
